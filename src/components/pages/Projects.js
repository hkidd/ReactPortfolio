        ...
        <div className="col-sm">
          <div className="card mx-auto" style={styles.card}>
            ...
            <div className="card-body">
              ...
              rel="noreferrer" href="https://jobster-group-2.herokuapp.com/aboutus" className="btn btn-primary">
                Live Deployment
              </a>
              <a style={styles.a} target="_blank"
              rel="noreferrer" href="https://github.com/hkidd/Jobster" className="btn btn-primary">
                GitHub
              </a>
            </div>
          </div>
          ...
          <div className="card mx-auto" style={styles.card}>
            ...
            <div className="card-body">
              ...
              <a style={styles.a} target="_blank"
              rel="noreferrer" href="https://cnvives.github.io/group-3/" className="btn btn-primary">
                Live Deployment
              </a>
              <a style={styles.a} target="_blank"
              rel="noreferrer" href="https://github.com/cnvives/group-3" className="btn btn-primary">
                GitHub
              </a>
            </div>
          </div>
        ...
        <div className="col-sm">
          <div className="card mx-auto" style={styles.card}>
            ...
            <div className="card-body">
              ...
              <a style={styles.a} target="_blank"
              rel="noreferrer" href="https://note-taker-hk.herokuapp.com " className="btn btn-primary">
                Live Deployment
              </a>
              <a style={styles.a} target="_blank"
              rel="noreferrer" href="https://github.com/hkidd/NoteTaker" className="btn btn-primary">
                GitHub
              </a>
            </div>
          </div>
          ...
          <div className="card mx-auto" style={styles.card}>
            ...
            <div className="card-body">
              ...
              <a style={styles.a} target="_blank"
              rel="noreferrer" href="https://budget-tracker-hk.herokuapp.com" className="btn btn-primary">
                Live Deployment
              </a>
              <a style={styles.a} target="_blank"
              rel="noreferrer" href="https://github.com/hkidd/BudgetTracker" className="btn btn-primary">
                GitHub
              </a>
            </div>
          </div>
        ...
        <div className="col-sm">
          <div className="card mx-auto" style={styles.card}>
            ...
            <div className="card-body">
              ...
              <a style={styles.a} target="_blank"
              rel="noreferrer" href="https://github.com/hkidd/CodeQuiz" className="btn btn-primary">
                GitHub
              </a>
            </div>
          </div>
